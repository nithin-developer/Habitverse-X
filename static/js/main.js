            ...
            try {
                ...
                if (response.ok) {
                    ...
                    if (result.access_token) {
                        ...
                        // Redirect to dashboard with the token ready
    ...
    if (registerForm) {
        registerForm.addEventListener('submit', async (e) => {
            ...
            if (password !== confirmPassword) {
                ...
                registerForm.querySelector('#confirm_password').classList.add('input-error');
                return;
            }
    ...
    if (logoutLink) {
        logoutLink.addEventListener('click', async (e) => {
            ...
            try {
                ...
                // Even if error, clear token and redirect to home
                localStorage.removeItem('token');
                window.location.href = '/';
            }
        });
